...
namespace wnxd
{
	namespace Asm
	{
		...
		public:
			static void Register(Delegate^ source, Delegate^ destination, bool forcibly = false)
			{
				Register(source->Method, destination->Method, forcibly);
			}
			static void Register(IntPtr source, int sourcetoken, Delegate^ destination, bool forcibly = false, int methodhandle = 0, bool il = true, bool external = false)
			{
				Register((int)source, sourcetoken, destination->Method, forcibly, methodhandle, il, external);
			}
			static void Register(void* source, int sourcetoken, Delegate^ destination, bool forcibly = false, int methodhandle = 0, bool il = true, bool external = false)
			{
				Register((int)source, sourcetoken, destination->Method, forcibly, methodhandle, il, external);
			}
			static void Register(int source, int sourcetoken, Delegate^ destination, bool forcibly = false, int methodhandle = 0, bool il = true, bool external = false)
			{
				Register(source, sourcetoken, destination->Method, forcibly, methodhandle, il, external);
			}
			static void Register(MethodBase^ source, MethodBase^ destination, bool forcibly = false)
			{
			...
			static void Register(IntPtr source, int sourcetoken, MethodBase^ destination, bool forcibly = false, int methodhandle = 0, bool il = true, bool external = false)
			{
				Register((int)source, sourcetoken, destination, forcibly, methodhandle, il, external);
			}
			static void Register(void* source, int sourcetoken, MethodBase^ destination, bool forcibly = false, int methodhandle = 0, bool il = true, bool external = false)
			{
				Register((int)source, sourcetoken, destination, forcibly, methodhandle, il, external);
			}
			static void Register(int source, int sourcetoken, MethodBase^ destination, bool forcibly = false, int methodhandle = 0, bool il = true, bool external = false)
			{
